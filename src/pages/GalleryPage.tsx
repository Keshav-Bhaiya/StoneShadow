...
const PROJECTS: Project[] = [
  ...
  { image: 'https://images.pexels.com/photos/2219024/pexels-photo-2219024.jpeg?auto=compress&cs=tinysrgb&w=600',      name: 'Black Limestone Cobbles',  category: 'COBBLESTONES',       span: 'row-span-1', desc: 'Elegant black limestone cobbles for premium outdoor flooring.' },
  { image: 'https://images.pexels.com/photos/1029243/pexels-photo-1029243.jpeg?auto=compress&cs=tinysrgb&w=600',      name: 'Sagar Black Cobbles',      category: 'COBBLESTONES',       span: 'row-span-1', desc: 'Deep black sagar stone cobbles, highly durable and weather resistant.' },
  { image: 'https://images.pexels.com/photos/3934512/pexels-photo-3934512.jpeg?auto=compress&cs=tinysrgb&w=600',      name: 'Multicolor Cobbles',       category: 'COBBLESTONES',       span: 'row-span-1', desc: 'Vibrant multicolor cobbles adding character to any outdoor space.' },
  ...
  { image: 'https://images.pexels.com/photos/1457842/pexels-photo-1457842.jpeg?auto=compress&cs=tinysrgb&w=600',      name: 'Mosaic Pattern Interior',  category: 'WALL CLADDING',      span: 'row-span-1', desc: 'Intricate mosaic patterns bringing artistic flair to interior walls.' },
  ...
  { image: 'https://images.pexels.com/photos/2227832/pexels-photo-2227832.jpeg?auto=compress&cs=tinysrgb&w=600',      name: 'Stone Table',              category: 'STONE CRAFT',        span: 'row-span-1', desc: 'Solid stone tables combining functionality with natural elegance.' },
  ...
  { image: 'https://images.pexels.com/photos/259588/pexels-photo-259588.jpeg?auto=compress&cs=tinysrgb&w=600',        name: 'Dholpur Stone',            category: 'SANDSTONE FLOORING', span: 'row-span-1', desc: 'Classic Dholpur sandstone known for its warm beige tones.' },
  ...
  { image: 'https://images.pexels.com/photos/3822843/pexels-photo-3822843.jpeg?auto=compress&cs=tinysrgb&w=600',      name: 'Rainbow Sandstone',        category: 'SANDSTONE FLOORING', span: 'row-span-1', desc: 'Multi-toned rainbow sandstone with stunning natural color variation.' },

  // SPECIAL STONES
  { image: 'https://images.pexels.com/photos/3041977/pexels-photo-3041977.jpeg?auto=compress&cs=tinysrgb&w=600',      name: 'Mandana Red Stone',        category: 'SPECIAL STONES',     span: 'row-span-2', desc: 'Vibrant red Mandana stone from Rajasthan — iconic and long-lasting.' },
  { image: 'https://images.pexels.com/photos/1029243/pexels-photo-1029243.jpeg?auto=compress&cs=tinysrgb&w=600',      name: 'Kandla Grey Stone',        category: 'SPECIAL STONES',     span: 'row-span-1', desc: 'Cool grey Kandla stone perfect for contemporary outdoor designs.' },
  { image: 'https://images.pexels.com/photos/1571460/pexels-photo-1571460.jpeg?auto=compress&cs=tinysrgb&w=600',      name: 'Kota Stone',               category: 'SPECIAL STONES',     span: 'row-span-1', desc: 'Affordable and durable Kota stone widely used across India.' },
  { image: 'https://images.pexels.com/photos/2219024/pexels-photo-2219024.jpeg?auto=compress&cs=tinysrgb&w=600',      name: 'Kadappa Stone',            category: 'SPECIAL STONES',     span: 'row-span-1', desc: 'Dark Kadappa stone with a smooth finish for modern interiors.' },
  { image: 'https://images.pexels.com/photos/3934512/pexels-photo-3934512.jpeg?auto=compress&cs=tinysrgb&w=600',      name: 'Sagar Black',              category: 'SPECIAL STONES',     span: 'row-span-1', desc: 'Premium Sagar Black stone with a polished mirror finish.' },
  { image: 'https://images.pexels.com/photos/2724749/pexels-photo-2724749.jpeg?auto=compress&cs=tinysrgb&w=600',      name: 'Basalt',                   category: 'SPECIAL STONES',     span: 'row-span-1', desc: 'Volcanic basalt stone — extremely hard and ideal for heavy traffic areas.' },
];
