...
const categories = [
  {
    ...
    image: "https://i.pinimg.com/1200x/0b/d5/2d/0bd52d036740cd746a2ec4638703af10.jpg",
    tag: "CLASSIC",
    color: "#5C3D2E",
  ...
  },
  {
    ...
    image: "https://i.pinimg.com/1200x/ec/05/54/ec0554f2a33129243fcb631add5f37d5.jpg",
    tag: "EXOTIC",
    color: "#92400e",
  ...
  },
  {
    ...
    image: "https://i.pinimg.com/736x/da/d0/4d/dad04d14c805ba6ae6f9f3523c46831b.jpg",
    tag: "BESPOKE",
    color: "#3f6212",
  ...
  },
  {
    ...
    image: "https://i.pinimg.com/1200x/60/80/4a/60804ac009ce365d492f3f6712e5c0a2.jpg",
    tag: "PREMIUM",
    color: "#5C3D2E",
    glow: "rgba(92,61,46,0.22)",
    lightBg: "rgba(92,61,46,0.06)",
      ...
      >
        ...
        <div className="absolute pointer-events-none"
          style={{ bottom: "-18%", right: "-6%", width: "42%", height: "60%",
            ...
            transform: "rotate(-14deg)", animation: "beamPulse 9s ease-in-out infinite reverse", animationDelay: "3s" }} />
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            {/* Badge — matches Hero's SINCE 1999 style */}
            ...
            >
              Our Best{" "}
              <span className="text-[#5C3D2E]">Stone Categories</span>
            </h2>

            {/* Italic line — matches Hero */}
            <p
